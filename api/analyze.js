...
■ 불확실성 표시 (중요!)
각 영수증 객체 안에, 분석 확신이 낮은 항목이 있으면 "questions" 필드를 추가하세요.
- 글자가 흐리거나 잘려서 금액/날짜/가게명 등을 정확히 읽기 어려운 경우
- 영수증 유형을 확실히 구분하기 어려운 경우
- 주소나 지역을 특정하기 어려운 경우
questions는 사용자에게 확인할 질문을 한국어 문자열 배열로 작성하세요.
예: "questions": ["금액이 23,700원이 맞나요? 글자가 흐려서 확인이 필요합니다.", "출발역이 서울역이 맞나요?"]
확신이 높으면 questions 필드를 포함하지 마세요.`;
